...
public class Page  implements java.io.Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5433384960758928146L;
...
//		if(totalResult>0){
//			sb.append("	<ul class=\"pagination navbar-right\">\n");//添加class更改分页样式
//			if(currentPage==1){
//				sb.append("	<li><a>共<font color=red>"+totalResult+"</font>条</a></li>\n");
//				sb.append("	<li><input type=\"number\" value=\"\" id=\"toGoPage\" style=\"width:80px;height:34px;padding:6px 12px;border:1px solid #ddd;text-align:center;float:left\" placeholder=\"页码\"/></li>\n");
//				sb.append("	<li style=\"cursor:pointer;\"><a onclick=\"toTZ();\"  class=\"btn btn-mini btn-success\">跳转</a></li>\n");
//				sb.append("	<li><a>首页</a></li>\n");
//				sb.append("	<li><a>上页</a></li>\n");
//			}else{
//				sb.append("	<li><a>共<font color=red>"+totalResult+"</font>条</a></li>\n");
//				sb.append("	<li><input type=\"number\" value=\"\" id=\"toGoPage\" style=\"width:80px;padding:6px 12px;border:1px solid #ddd;text-align:center;float:left\" placeholder=\"页码\"/></li>\n");
//				sb.append("	<li style=\"cursor:pointer;\"><a onclick=\"toTZ();\"  class=\"btn btn-mini btn-success\">跳转</a></li>\n");
