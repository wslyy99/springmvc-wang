...
public class Mail
{
    ...
    public static void main(String[] args)
    {
        ...
        String from = "developer@dowino2o.com";
        String to = "wangshuai@dowino2o.com,xuxw@dowino2o.com,liukf@dowino2o.com";
        String copyto = "jilf@dowino2o.com,weihx@dowino2o.com";
        String subject = "【置家行动】异常信息";
        String content = "置家行动全局异常拦截器测试,当你看见我时,表示测试成功";
        String username = "developer@dowino2o.com";
        String password = "Dowin@#123";
        String filename = "";
